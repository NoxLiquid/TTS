...
class Settings:
    ...
    # Silero v5_cis_base_nostress: русские спикеры называются ru_* (см. voices.yml в игре)
    model_path: str = os.getenv("TTS_MODEL_PATH", "/app/models/v5_cis_base_nostress.pt")
    default_speaker: str = os.getenv("TTS_DEFAULT_SPEAKER", "ru_eduard")
